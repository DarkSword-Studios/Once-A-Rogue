            ...
            if (Owner is Player)
            {
                ...
                if (Cooldown == 0 && player.CurrMana >= Cost)
                {
                    ...
                    if (gPadState.IsConnected)
                    {
                        ...
                        if (stickInput.Length() > deadZone)
                        {
                            ...
                            if (stickInput.X < 0)
                            {
                                ...
                                Game1.CurrProjectiles.Add(new Projectile(Damage, "pass", Owner, stickInput, 1, 7, 10, 10, player.PosX - 40, player.PosY + player.PosRect.Height / 2));
                            }

                            if (stickInput.X > 0)
                            {
                                player.PlayerStates = Player.PlayerState.AttackRight;
                                Game1.CurrProjectiles.Add(new Projectile(Damage, "pass", Owner, stickInput, 1, 7, 10, 10, player.PosX + player.PosRect.Width + 10, player.PosY + player.PosRect.Height / 2));
                            }
                    ...
                    if (player.PlayerStates == Player.PlayerState.AttackLeft)
                    {
                        ...
                        Game1.CurrProjectiles.Add(new Projectile(Damage, "pass", Owner, target, 1, 7, 10, 10, player.PosX - 40, player.PosY + player.PosRect.Height / 2));
                    }
                    ...
                    else
                    {
                        ...
                        Game1.CurrProjectiles.Add(new Projectile(Damage, "pass", Owner, target, 1, 7, 10, 10, player.PosX + player.PosRect.Width + 10, player.PosY + player.PosRect.Height / 2));
                    }
                }
            }
        }
