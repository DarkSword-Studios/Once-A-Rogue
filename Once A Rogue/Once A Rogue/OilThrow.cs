        ...
        public override void OnActivated()
        {
            ...
            if (Owner is Player)
            {
                ...
                if (Cooldown == 0 && player.CurrMana >= Cost)
                {
                    ...
                    if (gPadState.IsConnected)
                    {
                        ...
                        if (stickInput.Length() > deadZone)
                        {
                            ...
                            if (stickInput.X < 0)
                            {
                                ...
                                Game1.CurrProjectiles.Add(new Projectile(Damage, "oil", Owner, stickInput, 0, 7, 10, 10, player.PosX - 40, player.PosY + player.PosRect.Height / 2));
                            }

                            if (stickInput.X > 0)
                            {
                                player.PlayerStates = Player.PlayerState.AttackRight;
                                Game1.CurrProjectiles.Add(new Projectile(Damage, "oil", Owner, stickInput, 0, 7, 10, 10, player.PosX + player.PosRect.Width + 10, player.PosY + player.PosRect.Height / 2));
                            }
                    ...
                    if (player.PlayerStates == Player.PlayerState.AttackLeft)
                    {
                        ...
                        Game1.CurrProjectiles.Add(new Projectile(0, "oil", Owner, target, 0, 7, 10, 10, player.PosX - 40, player.PosY + player.PosRect.Height / 2));
                    }
                    ...
                    else
                    {
                        ...
                        Game1.CurrProjectiles.Add(new Projectile(0, "oil", Owner, target, 0, 7, 10, 10, player.PosX + player.PosRect.Width + 10, player.PosY + player.PosRect.Height / 2));
                    }
                }
            }
            ...
            if (Owner is Enemy)
            {
                ...
                if (enemy.player.PosX <= enemy.PosX)
                {
                    ...
                    Game1.CurrProjectiles.Add(new Projectile(Damage, "fire", Owner, target, 0, 7, 10, 10, enemy.PosX - 40, enemy.PosY + enemy.PosRect.Height / 2));
                }
                ...
                else
                {
                    ...
                    Game1.CurrProjectiles.Add(new Projectile(Damage, "fire", Owner, target, 0, 7, 10, 10, enemy.PosX + enemy.PosRect.Width + 10, enemy.PosY + enemy.PosRect.Height / 2));
                }
            }
        }
    }
