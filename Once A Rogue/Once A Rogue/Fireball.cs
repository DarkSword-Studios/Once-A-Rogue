    ...
    //This class represents a fireball skill that the Player will be a able to use
    {
        ...
        public override void OnActivated()
        {
            ...
            if(Owner is Enemy)
            {
                ...
                Game1.CurrProjectiles.Add(new Projectile(Damage, "fire", Owner, target, 0, 7, 10, 10, enemy.PosX + enemy.PosRect.Width / 2, enemy.PosY + enemy.PosRect.Height / 2, 12, false));
            }
        }
    }
}