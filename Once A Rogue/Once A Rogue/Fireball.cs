    ...
    //This class represents a fireball skill that the Player will be a able to use
    {
        ...
        public override void OnActivated()
        {
            ...
            if (Owner is Player)
            {
                ...
                if (Cooldown == 0 && player.CurrMana >= Cost)
                {
                    ...
                    if (gPadState.IsConnected)
                    {
                        ...
                        if(stickInput.Length() > deadZone)
                        {
                            ...
                            if (stickInput.X < 0)
                            {
                                ...
                                Game1.CurrProjectiles.Add(new Projectile(Damage, "fire", Owner, stickInput, 0, 7, 10, 10, player.PosX - 40, player.PosY + player.PosRect.Height / 2, false));
                            }
                            ...
                            if (stickInput.X > 0)
                            {
                                ...
                                player.CurrMana -= Cost;
                                Game1.CurrProjectiles.Add(new Projectile(Damage, "fire", Owner, stickInput, 0, 7, 10, 10, player.PosX + player.PosRect.Width + 10, player.PosY + player.PosRect.Height / 2, false));
                            }
                    ...
                    if (player.PlayerStates == Player.PlayerState.AttackLeft)
                    {
                        ...
                        player.CurrMana -= Cost;
                        Game1.CurrProjectiles.Add(new Projectile(Damage, "fire", Owner, target, 0, 7, 10, 10, player.PosX - 10, player.PosY + player.PosRect.Height / 2, false));
                    }
                    ...
                    else
                    {
                        ...
                        player.CurrMana -= Cost;
                        Game1.CurrProjectiles.Add(new Projectile(Damage, "fire", Owner, target, 0, 7, 10, 10, player.PosX + player.PosRect.Width + 10, player.PosY + player.PosRect.Height / 2, false));
                    }
                }
            }
            ...
            if(Owner is Enemy)
            {
                ...
                Game1.CurrProjectiles.Add(new Projectile(Damage, "fire", Owner, target, 0, 7, 10, 10, enemy.PosX + enemy.PosRect.Width / 2, enemy.PosY + enemy.PosRect.Height / 2, false));
            }
        }
    }
}